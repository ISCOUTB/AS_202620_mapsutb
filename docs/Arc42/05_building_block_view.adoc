...
[plantuml, 05_building_block_view_level1, png]
----
@startuml
...
de la disponibilidad de estos servicios externos (ver <<section-design-decisions,decisiones de diseño>> y
...
[plantuml, 05_building_block_view_level2, png]
----
@startuml

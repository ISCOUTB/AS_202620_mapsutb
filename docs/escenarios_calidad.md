...
| 2 | Un usuario solicita una ruta hacia un punto del campus en exteriores; el sistema calcula la distancia y muestra la ubicacion. | Menos de 5 segundos, con margen de error de ubicación menor a 10 metros. |
...
> Estos escenarios operacionalizan el [árbol de utilidad](./arbol_utilidad.md) definido para el proyecto.
